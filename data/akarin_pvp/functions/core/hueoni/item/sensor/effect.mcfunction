...
execute unless predicate lib:effect/invisibility if entity @s[team=Green] run effect give @s minecraft:slowness 1 0 false
execute unless predicate lib:effect/invisibility if entity @s[team=Green] run effect give @s minecraft:mining_fatigue 5 0 false
